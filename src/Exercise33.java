...
public class Exercise33 extends Frame {
    ...
    public void paint(Graphics g) {
        ...
        g2d.draw(new Ellipse2D.Double(90, 140, 2, 2));
        g2d.drawLine(100, 120, 90, 140);
        ...
        // Draw control points for the quadratic curve
        g2d.draw(new Ellipse2D.Double(170, 140, 2, 2));
        g2d.drawLine(180, 120, 170, 140);
        ...
        g2d.draw(new Ellipse2D.Double(195, 100, 2, 2));
        g2d.draw(new Ellipse2D.Double(200, 80, 2, 2));
        g2d.drawLine(160, 80, 195, 100);
        g2d.drawLine(200, 80, 195, 100);
        ...
        // Draw dashed lines connecting the endings of the curves with their control points
        g2d.setStroke(new BasicStroke(1.0f, BasicStroke.CAP_BUTT, BasicStroke.JOIN_BEVEL, 0, new float[]{5}, 0));
        g2d.drawLine(90, 140, 100, 120);
        g2d.drawLine(170, 140, 180, 120);
        g2d.drawLine(160, 80, 195, 100);
    ...
    public static void main(String[] argv) {
        ...
        f.setTitle("Extended GeneralPath example");
        f.setSize(250, 200);
        f.setVisible(true);
    }
}
